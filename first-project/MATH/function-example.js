...
Это «мини-программа» внутри основной программы, позволяющая структурировать код, 
избегать повторений и упрощать отладку.
*/

// Памятка:
function имяФункции(параметр1, параметр2) {
    // Внутренний код (тело функции)
    let результат = параметр1 + параметр2;
    
    return результат; // Отдаем ответ наружу
} 
// вызвать функцию
let финал = имяФункции(1500, 250); 
console.log(финал);
